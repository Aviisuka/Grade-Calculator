// Team members: Avinash , Lokesh

// Project Team Name: Lokesh & Avinash
...
public class Project
 {
    ...
    public static void main(String[] args) {
        ...
        double avgHomework = (homeworkOne + homeworkTwo + homeworkThree + homeworkFour + homeworkFive + homeworkSix + homeworkSeven + homeworkEight)/8;
        ...
        double avgQuiz = (quizOne + quizTwo + quizThree + quizFour + quizFive)/5;
        ...
        System.out.println("Average mid term marks are \n" + avgmidTerm);
        ...
        System.out.println("Average final Exam marks \n" + avgfinalExam);
        ...
        System.out.println("Average project marks \n" + avgProject);


        

        final double Total = (avgHomework* 0.15) + (avgQuiz * 0.05) + (avgmidTerm) + (avgfinalExam) + (avgProject) ;
